...
define('GMB_CLIENT_ID', get_option('gmb_client_id', ''));
define('GMB_CLIENT_SECRET', get_option('gmb_client_secret', ''));
define('GMB_REDIRECT_URI', get_option('gmb_redirect_uri', admin_url('admin.php?page=gmb-settings&gmb_auth=1')));
define('GMB_ACCOUNT_ID', get_option('gmb_account_id', ''));
define('GMB_LOCATION_ID', get_option('gmb_location_id', ''));
