...
<div class="wrap gmb-admin-wrap">
    ...
    <?php if (isset($data['error']) && $data['error']): ?>
        <div class="notice notice-error">
            ...
            <?php endif; ?>
            <p><a href="<?php echo esc_url(admin_url('admin.php?page=gmb-settings')); ?>" class="button">Configurer l'authentification</a></p>
        </div>
    <?php elseif (empty($data['reviews'])): ?>
        <div class="notice notice-warning">
            <p>Aucun avis trouvé. Vérifiez votre configuration.</p>
            <p><a href="<?php echo esc_url(admin_url('admin.php?page=gmb-settings')); ?>" class="button">Vérifier la configuration</a></p>
        </div>
    <?php else: ?>
                ...
                <tr id="<?php echo esc_attr($form_id); ?>">
                    ...
                    <td>
                        <form method="post" style="display: flex; gap: 5px;">
                            ...
                            <input type="hidden" name="review_id" value="<?php echo esc_attr($parsed->review_id); ?>">
                            <input type="hidden" name="reviewer_name" value="<?php echo esc_attr($parsed->name); ?>">
                            <input type="text"
                                   name="job"
